  ...
  const itemRows = lineItems
    .map(li => `
      <tr>
        ...
        <td style="padding:14px 20px;border-bottom:1px solid #f0e6d3;text-align:right;color:#3d2b1f;font-size:15px;white-space:nowrap">${li.total}</td>
      </tr>`)
    .join('');
...
<body style="margin:0;padding:0;background:#f5f0eb;font-family:'Georgia','Times New Roman',serif">
  <div style="max-width:600px;margin:0 auto;background:#ffffff">
    ...
    <div style="background:#2c1810;padding:32px 20px;text-align:center">
      <h1 style="margin:0;color:#e8c36a;font-size:28px;font-weight:700;letter-spacing:1px">J RODGERS BBQ</h1>
    ...
    <!-- Divider -->
    <div style="padding:0 28px"><hr style="border:none;border-top:1px solid #f0e6d3;margin:0"></div>
...
<body style="margin:0;padding:0;background:#f0f0f0;font-family:sans-serif">
  <div style="max-width:600px;margin:0 auto;background:#fff">
    ...
    <div style="background:#fff3cd;padding:16px 24px;border-bottom:3px solid #e8c36a">
      <table style="width:100%"><tr>
    ...
    <div style="padding:20px 24px">
      <table style="width:100%;border-collapse:collapse">
        ...
        <tbody>
          ${lineItems.map(li => `<tr><td style="padding:10px 12px;border-bottom:1px solid #eee;font-size:15px">${li.quantity}x ${escapeHtml(li.name)}</td><td style="padding:10px 12px;border-bottom:1px solid #eee;text-align:right;font-size:15px">${li.total}</td></tr>`).join('')}
        </tbody>
